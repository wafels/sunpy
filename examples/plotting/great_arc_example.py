...
aia_gc_visibility = ArcVisibility(aia_gc)

stereo_gc_visibility = ArcVisibility(aia_gc.coordinates.transform_to(stereo.frame))


# The part of the arc which is visible from AIA and STEREO A.
both = np.logical_and(aia_gc_visibility.visibility, stereo_gc_visibility.visibility)

# The part of the arc which is not visible from either AIA or STEREO A.
neither = np.logical_and(~aia_gc_visibility.visibility, ~stereo_gc_visibility.visibility)
